<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Confirmation Sell {!! $crypto->name !!}</h5>
            <a class="btn-close"
                data-dismiss="modal"
        ...
        <div class="modal-body">
            <div class="auth-form">
              ...
              <form  class="identity-upload" method="POST" action="{!! route("back.sell_modal") !!}">
                    @csrf
                    <div class="identity-content">
                        <div class="text-center mt-4">
                            <input hidden value="{!! $currency_sell !!}" name="currency_sell">
